-- =====================================================
-- CAPITALIST API CRYPTO PAYMENT SYSTEM DATABASE SCHEMA
-- =====================================================
...
-- =====================================================
-- 3. COMPANY BALANCE TRACKING TABLE
-- =====================================================
CREATE TABLE IF NOT EXISTS public.company_balance (
    ...
    CONSTRAINT single_company_balance_record CHECK (id = gen_random_uuid())
);

-- Initialize company balance record
INSERT INTO public.company_balance (user_funds, company_funds, total_deposits, total_withdrawals, total_fees_earned)
VALUES (0, 0, 0, 0, 0)
