...
const LoginScreen = () => {
  const { login, t, isDarkMode } = useApp();
  ...
  const handleLogin = async (method) => {
    ...
    const userData = {
      id: 1,
      name: method === 'google' ? 'John Doe' : 'User',
      email: method === 'google' ? 'john.doe@example.com' : email,
      ...
      <Card className="w-full max-w-md shadow-2xl border-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
        ...
        <CardContent>
          ...
          <div className="mt-6">
            ...
            <Button
              variant="outline"
              className="w-full mt-4 border-[#0097B2]/20 hover:bg-[#0097B2]/5"
